...
import { createOpenClawBridgeMiddleware } from './openClawBridge.js'
...
export function createServer(options: ServerOptions = {}): ServerInstance {
  ...
  // 2. OpenClaw bridge for the optional local OpenClaw session source.
  app.use('/codex-api/openclaw', express.json({ limit: '2mb' }), createOpenClawBridgeMiddleware())
